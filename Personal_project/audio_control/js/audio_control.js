...
;(function(global, $){
  ...
  btn_play.onclick  = audio.play.bind(audio) && function(){img.setAttribute('style','border-radius:350px;transform: rotate(180deg);animation:coverlist-ani 1000s infinite;');};
  // btn_play.onclick  = function(){img.setAttribute('style','border-radius:350px;transform: rotate(180deg);animation:coverlist-ani 1000s infinite;');};

  btn_pause.onclick = audio.pause.bind(audio);
  btn_pause.onclick  = function(){img.setAttribute('style','border-radius:350px;');};

  btn_stop.onclick  = audio.stop.bind(audio);
  btn_stop.onclick  = function(){img.setAttribute('style','none;');};
